...
Citizen.CreateThread(function()
	while true do
		if ESX.IsPlayerLoaded(PlayerId) then
			...
			ESX.TriggerServerCallback('fg_hudv3:getjoblabel', function(joblabel)
				ESX.TriggerServerCallback('fg_hudv3:getjobgradelabel', function(jobgradelabel)
					ESX.TriggerServerCallback('fg_hudv3:getjobname', function(jobname)
			...
			ESX.TriggerServerCallback('fg_hudv3:getCash', function(money)
...
RegisterNetEvent("updateProgress")
AddEventHandler("updateProgress", function(progressValue)
    SendNUIMessage({
...
RegisterNetEvent('fg_hudv3:updateStatus')
AddEventHandler('fg_hudv3:updateStatus', function(status)
...
RegisterNetEvent('fg_hudv3:updateWeight')
AddEventHandler('fg_hudv3:updateWeight', function(weight)
...
RegisterCommand(Config.HudPostalCommand, function(source, args, rawCommand)
    if #args < 1 then
        if postalBlip then
            RemoveBlip(postalBlip.hndl)
            postalBlip = nil
